...
var tomessage=function(){
 ...
 var app = new Vue({
    el:"#app",
    data:{
        items:[{'channel':'python'},{'channel':'java'},{'channel':'php'}],
        art_items:'',
        showbule:false,
    ...
    methods:{
        ...
        get_article_bychanel:function(channel){
            axios.post(this.host+'/art_by_channel',{
                channel:channel
            },{
                responseType:'json',
                changeOrigin: true,
            ...
            .then(response=>{
                if(response.data.code==0){
                    this.items = response.data.channel_items
